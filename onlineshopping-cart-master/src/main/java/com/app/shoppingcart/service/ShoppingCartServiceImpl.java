...
import com.app.shoppingcart.dao.ShoppingCartDao;
...
import com.app.shoppingcart.helper.ProductResponseObject;
	...
	public List<Object> searchProductById(int id) throws ShoppingCartServiceException {
		...
		try {
			...
			if (product.getProductName().equals(prop.getProperty("cart.apparaltype"))) {
				...
				ApparalResponseDto apparalDto = productResponseObject.createApparalDtoResponseObject(apparal, product.getQuantity());
	...
	public List<Object> viewAllProduct() throws ShoppingCartServiceException {
		try {
			...
			for (Apparal apparal : apparalList) {
				ApparalResponseDto apparalDto = productResponseObject.createApparalDtoResponseObject(apparal, apparal.getQuantity());
				prods.add(apparalDto);
			}

			for (Book book : bookList) {
				BookResponseDto bookDto = productResponseObject.createBookDtoResponseObject(book, book.getQuantity());
				prods.add(bookDto);
			}
	...
	public List<Object> searchProductByCategory(String category) throws ShoppingCartServiceException {
		...
		try {
			...
			if (category.equals(prop.getProperty("cart.booktype"))) {
				...
				for (Book book : books) {
					BookResponseDto bookResponseDto = productResponseObject.createBookDtoResponseObject(book, book.getQuantity());
